...
class Options(argparse.ArgumentParser):
    def __init__(self, prog=NAME):
        usage = col.purple(
            """This script prepares the sequana pipeline atacseq layout to
            ...
            directory (atacseq) together with an executable script

            For a local run, use :

                sequana_pipelines_atacseq --input-directory PATH_TO_DATA 
